...
export default function Plates() {
    ...
    const {materials, loading, error, createPlate, updatePlate} = usePlates()
        ...
        try {
            ...
            if (editandoMaterial) {
                const newMaterial = {
                    ...
                    kilogramos: parseFloat(formData.kilograms),
                    metros: parseFloat(formData.meters)
                }

                const createdMaterial = await updatePlate(newMaterial);
            } else {
                const newMaterial = {
                    idCategoria: formData.categoria,
                    description: formData.descripcion,
                ...
                const createdMaterial = await createPlate(newMaterial);
                
            }
        } catch (error) {
            console.log(error);
        }finally{
            setFormData({ categoria: "", descripcion: "", detalle: "", motivo: 0, kilograms:"", meters:"" })
    ...
    const handleEditar = (material) => {
        ...
        setFormData({
            ...
            motivo: 0,
            detalle: "",
            kilograms: material.kilogramos.toString(),
            meters: material.metros_cuadrados.toString()
        })
    ...
    return (
        <div className="min-h-screen bg-white p-6">
            <div className="max-w-6xl mx-auto mt-10">
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2 text-center">Gestión de Placas</h1>
                </div>
                <div className="mb-8">
                    ...
                    <div className="fixed inset-0 backdrop-blur-sm bg-white/30 flex items-center justify-center z-50">
                        <div className="bg-white rounded-xl shadow-md p-6 w-full max-w-md mx-4">
                            <h2 className="text-xl font-bold text-gray-900 mb-4">
                                {editandoMaterial ? "Editar" : "Agregar"}
                            </h2>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {filteredMaterials.map((material) => (
                                    <tr key={material.idMaterial} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="text-sm font-medium text-gray-900 text-center">{material.metros_cuadrados}</div>
                                        </td>
                                        {!errorUser && ((
                        ...
                        {filteredMaterials.map((material) => (
                            <div key={material.idMaterial} className="p-4 border-b border-gray-200 last:border-b-0">
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        <h3 className="text-sm font-medium text-gray-900">METROS LINEALES: {material.metros_cuadrados}</h3>
                                    </div>
                                    {!errorUser && ((
